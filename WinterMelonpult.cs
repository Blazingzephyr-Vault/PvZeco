...
public class WinterMelonpult : PlantBase
{
	...
	protected override PlantType plantType => PlantType.Wintermelonpult;
	...
	private void CreateMelon()
	{
		...
		if (zombieBase != null || plantBase != null)
		{
			...
			if (base.IsFacingLeft)
			{
				...
				component.transform.rotation = Quaternion.Euler(0f, 0f, 78f);
			}
			else
			{
				vector = creatBulletOffsetPos;
				component.transform.rotation = Quaternion.Euler(0f, 0f, 258f);
			}
